        ...
        <div class="flex items-center justify-between py-1 bg-white mb-6">
            ...
            <div class="flex items-start">
                ...
                <a href="{{ route('vendor.direct-enquiries.index') }}" class="mx-2">
                    ...
                    <svg width="16" class="mt-2" height="10" viewBox="0 0 16 14" fill="none"
        ...
        <div class="space-y-6" x-data="{
            ...
            <div class="rounded mb-6">
                ...
                <div class="flex items-center justify-between px-5 py-3 border-b border-gray-200 bg-[#f7f7f7]">
                    ...
                    <button @click="openDetails = !openDetails" type="button"
                        ...
                        <svg class="w-4 h-4 transition-transform" :class="openDetails ? 'rotate-180' : ''" fill="none"
                ...
                <div x-show="openDetails" x-transition class="px-6 py-6 bg-[#f7f7f7]">
            ...
            <div class="rounded mb-6">
                ...
                <div class="flex items-center justify-between px-5 py-3 border-b border-gray-200 bg-[#f7f7f7]">
                    ...
                    <button @click="openRequirements = !openRequirements" type="button"
                        class="flex items-center cursor-pointer gap-1 text-xs bg-gray-200 px-3 py-1 rounded hover:bg-gray-300">

                        <span x-text="openRequirements ? 'Collapse' : 'Expand'"></span>

                        <svg class="w-4 h-4 transition-transform" :class="openRequirements ? 'rotate-180' : ''" fill="none"
                            stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div x-show="openRequirements" x-transition class="px-6 py-6 bg-[#f7f7f7]">
