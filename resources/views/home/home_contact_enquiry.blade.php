...
<div id="directEnquiryModal" class="fixed inset-0 z-50 hidden">
    <!-- Backdrop -->
    <div class="absolute inset-0 bg-gradient-to-br from-black/60 to-black/40 backdrop-blur-sm"
        onclick="closeDirectEnquiryModal()"></div>

    <!-- Modal Container -->
    <div class="relative h-full flex items-center justify-center p-4 sm:p-6">
        <div
            class="bg-white rounded-lg sm:rounded-xl shadow-2xl w-full max-w-lg max-h-[95vh] overflow-hidden flex flex-col">

            <!-- Header - Sticky -->
            <div
                class="bg-gradient-to-r from-[#009A5C] to-[#00b36b] px-4 sm:px-5 py-3 sm:py-4 text-white flex justify-between items-start sticky top-0 z-10 shadow-lg">
                <div class="flex-1">
            ...
            <div class="flex-1 overflow-y-auto">
                <form id="directEnquiryForm" action="{{ route('direct.enquiry.submit') }}" method="POST"
                    ...
                    <div class="form-group grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" id="nameInput" required minlength="3"
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="tel" id="phoneInput" name="phone" required maxlength="10"
                                    pattern="[6-9][0-9]{9}" placeholder="10-digit mobile no."
                    ...
                    <div class="form-group">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                            <label
                                class="relative flex items-center px-4 border-2 border-gray-200 rounded cursor-pointer hover:border-[#009A5C] transition-all group h-9">
                                <input type="checkbox" name="hoarding_type[]" value="DOOH" class="peer sr-only">
                                <div
                                    class="w-5 h-5 border-2 border-gray-300 rounded peer-checked:bg-[#009A5C] peer-checked:border-[#009A5C] flex items-center justify-center transition-all">
                                ...
                                <div class="ml-3 flex-1 flex flex-col justify-center">
                                    <span class="font-semibold text-gray-800 text-xs leading-tight">Digital
                                        (DOOH)</span>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="location_city" id="cityInput" required
                    ...
                    <div class="form-group">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
                            <label
                                class="relative flex items-center p-1 border-2 border-gray-200 rounded cursor-pointer hover:border-[#009A5C] transition-all h-9">
                            ...
                            <label
                                class="relative flex items-center p-3 border-2 border-gray-200 rounded cursor-pointer hover:border-[#009A5C] transition-all h-9">
                    ...
                    <div class="form-group">
                        ...
                        <div class="flex items-center gap-3">
                            <div
                                class="flex-1 bg-gray-50 border-2 border-gray-200 rounded flex items-center justify-between h-9 px-4">
                            ...
                            <input type="number" name="captcha" required placeholder="Answer"
                    ...
                    <div class="form-group">
                        <label class="relative flex items-start gap-3 p-3 border-2 border-gray-200 rounded-lg cursor-pointer
               hover:border-[#009A5C] transition-all bg-gray-50">
                            <input type="checkbox" id="customerAccountConsent" name="customer_account_consent" value="1"
                                required class="mt-1 w-4 h-4 accent-[#009A5C] cursor-pointer">
                            ...
                            <span class="text-xs sm:text-sm text-gray-700 leading-relaxed">
                                ...
                                <span class="text-gray-600">
                                    If you are a new customer, an account will be
                                    automatically created for you using the details
                                    provided above. If you are already registered,
                                    your enquiry will be submitted to your existing
                                    account.
                                </span>
...
<div id="otpModal" class="fixed inset-0 z-[60] hidden">
    ...
    <div class="relative h-full flex items-center justify-center p-4">
        <div class="bg-white rounded-lg shadow-2xl w-full max-w-md p-6 sm:p-8 text-center">
            ...
            <!-- OTP Input -->
            <input type="text" id="otpInput" inputmode="numeric" autocomplete="one-time-code" maxlength="4"
                placeholder="• • • •"
 ...
 */
    ...
    function updateSubmitButtonState() {
        ...
        const customerConsent =
            document.getElementById('customerAccountConsent')?.checked;
