<header id="header"
    class="bg-[#FBFBFB] mt-[-20px] border-b border-gray-100 fixed top-0 left-0 w-full z-50 md:h-43 transition-all duration-300">
        ...
        <div class="w-full px-6 md:px-10 lg:px-20 pr-4 hidden md:block">
            ...
            <div class="flex items-center justify-between  gap-4 ">
                ...
                <div class="flex items-center gap-3 ">
                    ...
                    <div class="flex items-center flex-shrink-0">
                        <a href="{{ route('home') }}" class="d-inline-block">
                            <x-optimized-image :src="route('brand.oohapp-logo')" alt="OOHApp company logo" width="150"
                                height="48"
                ...
                @php
                    ...
                    $dashboardUrl = auth()->check() && auth()->user()->hasRole('vendor')
                ...
                <div class="flex items-center space-x-4 lg:space-x-5">
                    ...
                    @auth
                        <div class="relative inline-block" id="userDropdownWrapper"
                            ...
                            <div id="userDropdown" style="display: none;"
                                class="absolute right-0 top-full w-64 bg-white border border-gray-200 rounded-lg shadow-lg z-[9999]">
                    ...
                    <a href="javascript:void(0)" onclick="openCart(event)" data-auth="{{ auth()->check() ? '1' : '0' }}"
                    ...
                    <a href="javascript:void(0)" onclick="openWishlist(event)"
                        ...
                        <span
                            class="absolute -top-2 -right-3 bg-red-500 text-white text-xs font-bold rounded-full w-5 h-5 items-center justify-center shortlist-count {{ $wishlistCount > 0 ? 'flex' : 'hidden' }}">
                            {{ $wishlistCount }}
                        </span>
                    </a>
            ...
            @if(!isset($hideSearch) || !$hideSearch)
                <div class="md:hidden pb-3 pt-2">
                    <form action="{{ route('search') }}" method="GET"
                        class="flex items-center w-full bg-gray-50 rounded-lg border border-gray-300">
                ...
                <div class="p-4 space-y-2 text-sm">
                    ...
                    <div class="flex items-center justify-between px-5   border-gray-200">
                        <a href="{{ route('home') }}" class="flex items-center space-x-1.5">
                            <x-optimized-image :src="route('brand.oohapp-logo')" alt="OOHApp  logo" width="150"
                                height="48" style="max-height:48px;object-fit:contain;" />
                        </a>
                    ...
                    <div id="mobile-menu"
                        ...
                        <div class="p-4 space-y-2 text-sm">
                            <!-- HEADER -->
                            <div class=" items-center justify-between px-2   border-gray-200">
                                <div class="flex items-center gap-4">

                                    {{-- Avatar --}}
                                    <div
                                        class="w-14 h-14 rounded-full bg-gray-100 flex items-center justify-center overflow-hidden border border-gray-200 shrink-0">
                                        ...
                                        @auth
                                            ...
                                            @else
                                                <svg class="w-8 h-8 md:w-10 md:h-10 text-gray-400" fill="none"
                                ...
                                <!-- MENU LINKS -->
                                <div class="flex flex-col px-5 pb-4 space-y-2 text-sm">
                            ...
                            Top Spots
                                    ...
                                    <a href="{{ route('search') }}"
                                        ...
                                        <svg width="32" height="30" viewBox="0 0 32 30" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M31.3647 23.0245C31.7754 22.796 31.7754 22.425 31.3647 22.1964L15.4082 13.3121C15.1776 13.1994 14.9227 13.1406 14.6642 13.1406C14.4057 13.1406 14.1508 13.1994 13.9203 13.3121L6.81738 17.2657L7.51496 17.6549L11.1798 15.621L27.2326 24.5549L23.8719 26.4232L24.6158 26.7843L31.3647 23.0245Z"
                                                fill="url(#paint0_linear_726_59043)" />
                                            <path
                                                d="M4.36041 18.0427L7.85 16.1016L23.2035 24.6463L19.7139 26.5891L4.36041 18.0427Z"
                                                fill="#D0D0D0" />
                                            <path
                                                d="M7.49976 0.940005V17.6435L6.80219 17.2543V0.550781L7.49976 0.940005Z"
                                                fill="#D0D0D0" />
                                            <path d="M7.5032 0.94544V17.6489L7.85371 17.4535V0.75L7.5032 0.94544Z"
                                                fill="#B2B2B2" />
                                            <path d="M2.79633 16.3954V16.0078L18.1498 24.5525V24.9417L2.79633 16.3954Z"
                                                fill="#B2B2B2" />
                                            <path
                                                d="M2.79636 16.0092L6.28594 14.0664L21.6394 22.6128L18.1498 24.5539L2.79636 16.0092Z"
                                                fill="#D0D0D0" />
                                            <path
                                                d="M21.6347 22.9986L21.6313 22.6094L18.1417 24.5505V24.9397L21.6347 22.9986Z"
                                                fill="#8DB3CD" />
                                            <path
                                                d="M6.27835 17.9506L9.76794 16.0078L10.1167 16.2016L6.62714 18.1444L6.27835 17.9506Z"
                                                fill="#B2B2B2" />
                                            <path
                                                d="M10.1224 20.0818L13.612 18.1406L13.9607 18.3344L10.4712 20.2772L10.1224 20.0818Z"
                                                fill="#B2B2B2" />
                                            <path
                                                d="M14.3054 22.4138L17.795 20.4727L18.1438 20.6664L14.6542 22.6092L14.3054 22.4138Z"
                                                fill="#B2B2B2" />
                                            <path
                                                d="M24.4305 9.39778L7.68705 0.079594C7.285 -0.15394 6.18023 0.132595 4.87614 0.858042L2.97586 1.9164C1.33158 2.83066 0 4.0944 0 4.73206V5.12791L0.343632 4.93413L16.7452 14.0618L24.4305 9.39778Z"
                                                fill="#949291" />
                                            <path d="M24.2549 10.2743V26.9778L23.5573 26.5902V9.88672L24.2549 10.2743Z"
                                                fill="#B2B2B2" />
                                            <path d="M23.5958 12.8188L24.1147 12.5273V12.9166L23.5958 13.2081V12.8188Z"
                                                fill="#BFD2D8" />
                                            <path
                                                d="M24.1146 12.52L23.7263 12.3047L23.5958 12.3792V12.8115L24.1146 12.52Z"
                                                fill="#B2B2B2" />
                                            <path d="M23.5958 23.8462L24.1146 23.5547V23.9439L23.5958 24.2354V23.8462Z"
                                                fill="#BFD2D8" />
                                            <path
                                                d="M24.1147 23.5591L23.7264 23.3438L23.5958 23.4183V23.8506L24.1147 23.5591Z"
                                                fill="#718090" />
                                            <path d="M24.2583 10.2719V26.9754L24.6088 26.78V10.0781L24.2583 10.2719Z"
                                                fill="#B2B2B2" />
                                            <path
                                                d="M24.6054 10.0806L23.9078 9.69141L23.5573 9.88685L24.2549 10.2744L24.6054 10.0806Z"
                                                fill="#718090" />
                                            <path d="M16.7517 28.8212L16.0541 28.4337V15.2266L16.7517 15.6141V28.8212Z"
                                                fill="#D0D0D0" />
                                            <path
                                                d="M16.0541 15.2294L23.0332 11.3438L23.7308 11.733L16.7517 15.6169L16.0541 15.2294Z"
                                                fill="#D0D0D0" />
                                            <path d="M23.7341 11.7344V24.9415L16.7549 28.8254V15.6183L23.7341 11.7344Z"
                                                fill="#5D5D5D" />
                                            <path d="M17.1017 28.2415L23.3833 24.7451V12.3164L17.1017 15.8128V28.2415Z"
                                                fill="white" />
                                            <path d="M23.3822 24.7451L23.0334 24.5513V12.5102L23.3822 12.3164V24.7451Z"
                                                fill="#5D5D5D" />
                                            <path
                                                d="M23.3833 24.7446L23.0346 24.5508L17.1017 27.8534V28.241L23.3833 24.7446Z"
                                                fill="#5D5D5D" />
                                            <path
                                                d="M24.6069 10.0852V9.69601C24.6069 9.05338 23.2753 9.27366 21.631 10.1929L19.7307 11.2513C18.0864 12.1655 16.7549 13.4292 16.7549 14.0669V14.4561L24.6069 10.0852Z"
                                                fill="#D0D0D0" />
                                            <path d="M16.7504 14.4568V14.0676L0 4.74609V5.13366L16.7504 14.4568Z"
                                                fill="#D0D0D0" />
                                            <path
                                                d="M19.5438 28.8186L23.5557 26.5859L24.2532 26.9735L20.2413 29.2078L19.5438 28.8186Z"
                                                fill="url(#paint1_linear_726_59043)" />
                                            <defs>
                                                <linearGradient id="paint0_linear_726_59043" x1="19.2451" y1="13.1406"
                                                    x2="19.2451" y2="26.7843" gradientUnits="userSpaceOnUse">
                                                    <stop />
                                                    <stop offset="1" stop-opacity="0" />
                                                </linearGradient>
                                                <linearGradient id="paint1_linear_726_59043" x1="21.8985" y1="26.5859"
                                                    x2="21.8985" y2="29.2078" gradientUnits="userSpaceOnUse">
                                                    <stop />
                                                    <stop offset="1" stop-opacity="0" />
                                                </linearGradient>
                                            </defs>
                                    ...
                                    <a href="{{ route('search', ['type' => 'dooh']) }}"
                                        ...
                                        <svg width="32" height="30" viewBox="0 0 32 30" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M31.2168 23.0245C31.6255 22.796 31.6255 22.425 31.2168 22.1964L15.3355 13.3121C15.106 13.1994 14.8524 13.1406 14.595 13.1406C14.3377 13.1406 14.0841 13.1994 13.8546 13.3121L6.78522 17.2657L7.4795 17.6549L11.1271 15.621L27.1041 24.5549L23.7592 26.4232L24.4997 26.7843L31.2168 23.0245Z"
                                                fill="url(#paint0_linear_726_59074)" />
                                            <path
                                                d="M4.33984 18.0427L7.81297 16.1016L23.094 24.6463L19.6209 26.5891L4.33984 18.0427Z"
                                                fill="#D0D0D0" />
                                            <path
                                                d="M7.46436 0.940005V17.6435L6.77008 17.2543V0.550781L7.46436 0.940005Z"
                                                fill="#D0D0D0" />
                                            <path d="M7.46783 0.94544V17.6489L7.81668 17.4535V0.75L7.46783 0.94544Z"
                                                fill="#B2B2B2" />
                                            <path d="M2.78314 16.3954V16.0078L18.0642 24.5525V24.9417L2.78314 16.3954Z"
                                                fill="#B2B2B2" />
                                            <path
                                                d="M2.7832 16.0092L6.25633 14.0664L21.5374 22.6128L18.0643 24.5539L2.7832 16.0092Z"
                                                fill="#D0D0D0" />
                                            <path
                                                d="M21.5327 22.9986L21.5293 22.6094L18.0562 24.5505V24.9397L21.5327 22.9986Z"
                                                fill="#8DB3CD" />
                                            <path
                                                d="M6.24872 17.9506L9.72184 16.0078L10.069 16.2016L6.59586 18.1444L6.24872 17.9506Z"
                                                fill="#B2B2B2" />
                                            <path
                                                d="M10.0746 20.0818L13.5478 18.1406L13.8949 18.3344L10.4218 20.2772L10.0746 20.0818Z"
                                                fill="#B2B2B2" />
                                            <path
                                                d="M14.2379 22.4138L17.711 20.4727L18.0582 20.6664L14.5851 22.6092L14.2379 22.4138Z"
                                                fill="#B2B2B2" />
                                            <path
                                                d="M24.3153 9.39778L7.65079 0.079594C7.25064 -0.15394 6.15107 0.132595 4.85314 0.858042L2.96182 1.9164C1.3253 2.83066 0 4.0944 0 4.73206V5.12791L0.342011 4.93413L16.6662 14.0618L24.3153 9.39778Z"
                                                fill="#949291" />
                                            <path d="M24.1404 10.2743V26.9778L23.4462 26.5902V9.88672L24.1404 10.2743Z"
                                                fill="#B2B2B2" />
                                            <path d="M23.4845 12.8188L24.0009 12.5273V12.9166L23.4845 13.2081V12.8188Z"
                                                fill="#BFD2D8" />
                                            <path
                                                d="M24.0009 12.52L23.6145 12.3047L23.4845 12.3792V12.8115L24.0009 12.52Z"
                                                fill="#B2B2B2" />
                                            <path d="M23.4845 23.8462L24.0009 23.5547V23.9439L23.4845 24.2354V23.8462Z"
                                                fill="#BFD2D8" />
                                            <path
                                                d="M24.0009 23.5591L23.6145 23.3438L23.4845 23.4183V23.8506L24.0009 23.5591Z"
                                                fill="#718090" />
                                            <path d="M24.1439 10.2719V26.9754L24.4927 26.78V10.0781L24.1439 10.2719Z"
                                                fill="#B2B2B2" />
                                            <path
                                                d="M24.4893 10.0806L23.795 9.69141L23.4462 9.88685L24.1404 10.2744L24.4893 10.0806Z"
                                                fill="#718090" />
                                            <path d="M16.6726 28.8212L15.9783 28.4337V15.2266L16.6726 15.6141V28.8212Z"
                                                fill="#D0D0D0" />
                                            <path
                                                d="M15.9783 15.2294L22.9246 11.3438L23.6189 11.733L16.6726 15.6169L15.9783 15.2294Z"
                                                fill="#D0D0D0" />
                                            <path d="M23.6221 11.7344V24.9415L16.6758 28.8254V15.6183L23.6221 11.7344Z"
                                                fill="#5D5D5D" />
                                            <path d="M17.0211 28.2415L23.273 24.7451V12.3164L17.0211 15.8128V28.2415Z"
                                                fill="#CE2A96" />
                                            <path d="M23.2719 24.7451L22.9248 24.5513V12.5102L23.2719 12.3164V24.7451Z"
                                                fill="#5D5D5D" />
                                            <path
                                                d="M23.273 24.7446L22.9259 24.5508L17.0211 27.8534V28.241L23.273 24.7446Z"
                                                fill="#5D5D5D" />
                                            <path
                                                d="M24.4908 10.0852V9.69601C24.4908 9.05338 23.1655 9.27366 21.529 10.1929L19.6377 11.2513C18.0011 12.1655 16.6758 13.4292 16.6758 14.0669V14.4561L24.4908 10.0852Z"
                                                fill="#D0D0D0" />
                                            <path d="M16.6713 14.4568V14.0676L0 4.74609V5.13366L16.6713 14.4568Z"
                                                fill="#D0D0D0" />
                                            <path
                                                d="M19.4516 28.8186L23.4446 26.5859L24.1389 26.9735L20.1459 29.2078L19.4516 28.8186Z"
                                                fill="url(#paint1_linear_726_59074)" />
                                            <defs>
                                                <linearGradient id="paint0_linear_726_59074" x1="19.1543" y1="13.1406"
                                                    x2="19.1543" y2="26.7843" gradientUnits="userSpaceOnUse">
                                                    <stop />
                                                    <stop offset="1" stop-opacity="0" />
                                                </linearGradient>
                                                <linearGradient id="paint1_linear_726_59074" x1="21.7952" y1="26.5859"
                                                    x2="21.7952" y2="29.2078" gradientUnits="userSpaceOnUse">
                                                    <stop />
                                                    <stop offset="1" stop-opacity="0" />
                                                </linearGradient>
                                            </defs>
                                    ...
                                    <button type="button" onclick="openEnquiryPopup()"
                                        ...
                                        <svg width="32" height="30" viewBox="0 0 24 24" fill="none"
                                            ...
                                            <path
                                                ...
                                                stroke-linejoin="round" />
                                            <path d="M8 8H16M8 11H14" stroke="currentColor" stroke-width="1.8"
                                    ...
                                    @auth
                                        <form method="POST" action="{{ route('logout') }}">
                                            ...
                                            <button type="submit"
                                                class="w-full flex items-center gap-3 px-2 rounded-md text-gray-700 hover:bg-gray-100 hover:text-red-600 transition cursor-pointer">
                                                <svg width="32" height="30" viewBox="0 0 24 24" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M10 17L15 12L10 7M15 12H3M21 3V21" stroke="currentColor"
