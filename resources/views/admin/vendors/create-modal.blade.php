<form action="{{ route('admin.vendors.quick-store') }}" method="POST"  id="vendorCreateForm">
    @csrf

    <input type="text" name="fake_username" style="position:absolute;top:-9999px;left:-9999px;" autocomplete="username">
    <input type="password" name="fake_password" style="position:absolute;top:-9999px;left:-9999px;"
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div>
            ...
            <div class="flex">
                ...
                <input type="text" name="phone" value="{{ old('phone') }}" class="border rounded-r px-3 py-2 w-full"
        ...
        <!-- <div class="md:col-span-3">
            ...
            <input type="password" name="password" class="border rounded px-3 py-2 w-full" autocomplete="new-password"
    ...
    <!-- <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div>
            ...
            <input type="text" name="company_name" value="{{ old('company_name') }}"
                class="border rounded px-3 py-2 w-full" autocomplete="off" required>
            @error('company_name') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
        </div>

        <div>
            <label class="block mb-1">GSTIN</label>
            <input type="text" name="gstin" value="{{ old('gstin') }}" class="border rounded px-3 py-2 w-full"
                autocomplete="off">
        ...
        <div>
            ...
            <input type="text" name="pan" value="{{ old('pan') }}" class="border rounded px-3 py-2 w-full"
                autocomplete="off">
        ...
        <div class="md:col-span-3">
            ...
            <input type="text" name="address" value="{{ old('address') }}" class="border rounded px-3 py-2 w-full"
                autocomplete="off" required>
            @error('address') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
        </div>
        <div>
            <label class="block mb-1">Pincode <span class="text-red-500">*</span></label>
            <input type="text" name="pincode" maxlength="6" id="pincodeField" value="{{ old('pincode') }}"
                class="border rounded px-3 py-2 w-full" autocomplete="off" required>
        ...
        <div>
            ...
            <input type="text" name="city" id="cityField" value="{{ old('city') }}"
                class="border rounded px-3 py-2 w-full" autocomplete="off" required>
        ...
        <div>
            ...
            <input type="text" name="state" id="stateField" value="{{ old('state') }}"
                class="border rounded px-3 py-2 w-full" autocomplete="off" required>
