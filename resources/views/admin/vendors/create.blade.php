              ...
              <form action="{{ route('admin.vendors.store') }}" method="POST" autocomplete="new-password">
                     ...
                     <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                   ...
                                   <div class="flex">
                                          <span
                                                 class="inline-flex items-center px-2 bg-gray-100 border border-r-0 rounded-l">+91</span>
                                          <input type="text" name="phone" value="{{ old('phone') }}"
                                                 class="border rounded-r px-3 py-2 w-full" inputmode="numeric"
                            ...
                            <div>
                                   ...
                                   <input type="email" name="email" value="{{ old('email') }}"
                                          class="border rounded px-3 py-2 w-full" autocomplete="off" autocorrect="off"
                     ...
                     <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                   ...
                                   <input type="text" name="pincode" maxlength="6" id="pincodeField"
                                          value="{{ old('pincode') }}" class="border rounded px-3 py-2 w-full"
                                          autocomplete="off" required>
                     ...
                     <div class="flex justify-end gap-2 mt-8">
                            <a href="{{ route('admin.vendors.index') }}"
                                   class="px-6 py-2 rounded border border-gray-300 bg-white">
                                   Cancel
                            </a>

                            <button type="submit"
                                   class="px-6 py-2 rounded bg-green-600 text-white font-semibold hover:bg-green-700">
                                   Save Vendor
                            </button>
                     </div>
