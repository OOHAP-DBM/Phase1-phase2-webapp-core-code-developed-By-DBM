...
@section('content')
                ...
                <div class="relative ml-4 h-6 w-11 shrink-0">
        ...
        ></button>
                    ...
                    >
                        ...
                        <p class="text-xs leading-5 text-gray-500">
                         ...
                         @push('scripts')
                            ...
                            document.addEventListener('DOMContentLoaded', function () {
                                ...
                                const bodyInput =
                                    document.getElementById('email_body');
                        ...
                        @push('styles')
                            ...
                            .email-editor-toolbar .ql-html-source {
                                width: 30px;
                                height: 30px;
                                border-radius: 7px;
                                position: relative;
                            ...
                            .email-editor-toolbar .ql-html-source::before {
                                content: "</>";
                                position: absolute;
                                top: 50%;
                                left: 50%;
                            ...
                            .email-editor-toolbar .ql-html-source:hover {
                                background: #eeeeee;
                            }

                            .email-editor-toolbar .ql-html-source:hover::before {
                                color: #00995c;
                            }
