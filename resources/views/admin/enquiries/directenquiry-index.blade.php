            ...
            <form method="GET" class="w-full sm:w-80">
                <div class="relative">
                    <input type="text" name="search" value="{{ request('search') }}"
                        placeholder="Search name, email, phone, city" class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg text-sm
                    ...
                    <tbody class="divide-y">
                        @forelse($enquiries as $index => $enquiry)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-4 py-3 text-center">
                                    <a href="{{ route('admin.direct-enquiries.adminvendorshow', $enquiry) }}"
                                        class="inline-flex items-center px-3 py-1.5 text-xs font-medium text-white bg-black hover:bg-gray-800 rounded-md">
                                        View Vendors
                                    </a>
                                </td>
