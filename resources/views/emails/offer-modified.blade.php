{{-- resources/views/emails/offer-modified.blade.php --}}
<!DOCTYPE html>
<html>
<head><meta charset="UTF-8"><title>Offer Updated - OOHAPP</title></head>
...
<td align="center" style="padding:20px 40px 0 40px;">
    <h2 style="margin:0; color:#2563eb; font-weight:600;">Your Offer Has Been Updated ↻</h2>
    <p style="margin-top:8px; color:#666; font-size:14px;">
        Hi {{ $offer->customer->name ?? 'Customer' }}, {{ $offer->vendor->name ?? 'your vendor' }} has made changes to offer <strong>#{{ $offer->offer_number }}</strong>.
    </p>
</td>
</tr>
...
<td style="padding:15px 40px; font-size:14px; color:#444; line-height:22px;">
    <p>Please review the updated details below and respond at your convenience.</p>
</td>
</tr>
...
<tr>
    <td style="padding:10px; font-size:13px;"><strong>Version</strong></td>
    <td style="padding:10px; font-size:13px;">
        <span style="background:#dbeafe; color:#1e40af; padding:4px 8px; font-weight:bold;">v{{ $offer->version }}</span>
    </td>
</tr>
<tr>
    <td style="padding:10px; font-size:13px;"><strong>Status</strong></td>
    <td style="padding:10px; font-size:13px;">
        <span style="background:#dbeafe; color:#1e40af; padding:4px 8px; font-weight:bold;">{{ ucfirst($offer->status) }}</span>
    </td>
</tr>
<tr>
...
<tr>
    <td style="padding:10px; font-size:13px;"><strong>Updated Total Price</strong></td>
...
<tr style="background:#eff6ff;"><td colspan="2" style="padding:10px; font-size:14px; color:#1e3a8a;"><strong>{{ $offer->vendor->name ?? '-' }}</strong></td></tr>
<tr>
...
<tr>
    ...
    <td style="padding:8px 10px; font-size:13px;">
        <a href="mailto:{{ $offer->vendor->email }}" style="color:#2563eb; text-decoration:none;">{{ $offer->vendor->email ?? '-' }}</a>
    </td>
</tr>
</table>
</td>
...
<tr>
<td style="padding:20px 40px 0 40px;">
    <p style="font-size:14px; color:#444;"><strong>Updated Hoarding List</strong></p>
</td>
</tr>
...
<td style="padding:12px; font-size:14px; color:#1e3a8a;">
...
<tr>
<td style="padding:10px; font-size:13px; background:#eff6ff;">
...
<tr>
<td style="padding:10px; font-size:13px; color:#2563eb;">
...
<tr>
<td style="padding:10px 40px;">
<table width="100%" cellpadding="0" cellspacing="0" style="border:2px solid #2563eb;">
<tr style="background:#eff6ff;">
    <td style="padding:14px; font-size:16px; font-weight:bold; color:#1e3a8a;">Updated Total Amount</td>
    <td style="padding:14px; font-size:18px; font-weight:bold; color:#2563eb; text-align:right;">₹{{ number_format((float) $offer->price, 2) }}</td>
</tr>
</table>
</td>
</tr>
...
<td align="center" style="padding:20px 40px;">
    <a href="{{ route('customer.offers.show', $offer->id) }}"
       style="background:#2563eb; color:#ffffff; padding:12px 26px; font-size:14px; text-decoration:none; border-radius:6px; display:inline-block;">
        View Updated Offer
    </a>
</td>
</tr>
