    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="background-color:#f4f6f8; padding:40px 0;">
        <tr>
                ...
                <table width="600" cellpadding="0" cellspacing="0"
                        ...
                        <td style="padding:0 40px;">
                            <table width="100%" cellpadding="0" cellspacing="0" border="0"
                                ...
                                <tr style="background:#f3f4f6;">
                                    <th align="left" style="padding:10px; font-size:13px;">
                                        Field
                                    </th>
                                    <th align="left" style="padding:10px; font-size:13px;">
                                        Details
                    ...
                    <tr>
                        <td align="center" style="padding:25px 40px;">
                            <a href="https://staging.oohapp.io/customer/dashboard" style="background:#16a34a;
                      color:#ffffff;
                      padding:12px 24px;
                      font-size:14px;
                    ...
                    <tr>
                        <td style="padding:0 40px 10px 40px; font-size:14px; color:#444; line-height:22px;">
                            ...
                            <p>Your dashboard is already live — feel free to explore and start planning your next
                                campaign.</p>

                            <p><strong>Security tip:</strong> Keep your password confidential. We never ask for your
            ...
            ">
                                ...
                                OOHAPP remains a facilitating platform and does not take part in deal discussions or
                                execution.
                            </div>
                        </td>
                    </tr>
