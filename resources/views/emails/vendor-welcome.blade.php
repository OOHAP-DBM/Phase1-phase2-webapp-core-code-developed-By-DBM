                ...
                <table width="600" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td style="padding:0 40px;">
                            <table width="100%" cellpadding="0" cellspacing="0" border="0"
                                ...
                                <tr>
                                    <td style="padding:10px; font-size:13px;"><strong>Password</strong></td>
                                    <td style="padding:10px; font-size:13px;">{{ $password }}</td>
                                </tr>
                                <tr>
                    ...
                    <tr>
                        <td align="center" style="padding:25px 40px;">
                            <a href="https://staging.oohapp.io/vendor/dashboard" style="background:#16a34a;
                      color:#ffffff;
                      padding:12px 24px;
                      font-size:14px;
                    ...
                    <tr>
                        <td style="padding:0 40px 10px 40px; font-size:14px; color:#444; line-height:22px;">
                            ...
                            <p>Once your profile is approved, your media will be visible to brands actively looking to
                                book.</p>

                            <p><strong>Quick tip:</strong> Clear photos and accurate details help you get approved
                                faster and attract better enquiries.</p>

                            <p><strong>Security reminder:</strong> Keep your password safe. We never ask for your
                                password via email.</p>

                            <p>If you need help, contact us at <a
                                    href="mailto:support@oohapp.com">support&#64;oohapp&#46;com</a>.</p>
