                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                ...
                                @if($quotation->vendor->phone)
                                    <p class="mb-0 text-muted"><i class="bi bi-telephone"></i> {{ $quotation->vendor->phone }}
                                    </p>
                                @endif
                            </div>
                            <div class="col-md-6 text-end">
                                ...
                                @if($quotation->customer->phone)
                                    <p class="mb-0 text-muted"><i class="bi bi-telephone"></i> {{ $quotation->customer->phone }}
                                    </p>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="alert alert-info mb-4">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <p class="mb-1"><strong>Offer Reference:</strong> #{{ $quotation->offer_id }}
                                        (v{{ $quotation->offer->version }})</p>
                                    <p class="mb-0"><strong>Date:</strong> {{ $quotation->created_at->format('M d, Y') }}
                                    </p>
                                </div>
                                <div class="col-md-6">
                                    <p class="mb-1"><strong>Hoarding:</strong>
                                        {{ $quotation->offer->price_snapshot['hoarding_title'] ?? 'N/A' }}</p>
                                    <p class="mb-1"><strong>Location:</strong>
                                        {{ $quotation->offer->price_snapshot['hoarding_location'] ?? 'N/A' }}</p>
                                    <p class="mb-0"><strong>Duration:</strong>
                                        {{ $quotation->offer->price_snapshot['duration_days'] ?? 0 }} days</p>
                                </div>
                            </div>
                        </div>
                                ...
                                <table class="table table-sm">
                                    ...
                                    <tr class="table-primary">
                                        ...
                                        <td class="text-end"><strong
                                                class="text-primary fs-5">₹{{ number_format($quotation->grand_total, 2) }}</strong>
                                        </td>
                                    </tr>
                                </table>
                            </div>
