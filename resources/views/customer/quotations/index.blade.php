                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-2">
                                        @if($quotation->enquiry->hoarding->image)
                                            <img src="{{ asset('storage/' . $quotation->enquiry->hoarding->image) }}"
                                                alt="{{ $quotation->enquiry->hoarding->title }}" class="img-fluid rounded"
                                        ...
                                        <div class="d-flex align-items-start justify-content-between mb-2">
                                            <div>
                                                ...
                                                <p class="text-muted small mb-0">
                                                    ...
                                                    {{ $quotation->enquiry->hoarding->city }},
                                                    {{ $quotation->enquiry->hoarding->state }}
                                                </p>
                                            </div>
                                            <span class="badge 
                                    ...
                                    <div class="col-md-4 text-end">
                                        ...
                                        @if($quotation->status === 'pending')
                                            ...
                                            @endphp
                                            @if($daysLeft > 0)
                                                <form action="{{ route('customer.quotations.accept', $quotation->id) }}" method="POST"
