...
>
    ...
    <div class="bg-white px-3  pb-2">
        <a href="{{ route('admin.profile.edit') }}" class="flex items-center space-x-2 group {{ request()->routeIs('admin.profile.edit') ? 'bg-[#00995c] text-white' : '' }} rounded-lg p-2 transition-colors duration-200">
            ...
            <div>
                <p class="flex items-center gap-3 text-sm font-medium {{ request()->routeIs('admin.profile.edit') ? 'text-white' : 'text-gray-900' }}">
                    {{ Auth::user()->name }}
                ...
                <p class="text-xs {{ request()->routeIs('admin.profile.edit') ? 'text-yellow-200' : 'text-yellow-600' }}">
                    Admin
                </p>
            </div>
        </a>
            ...
            <div>
                <a href="{{ route('admin.commission.index') }}"
                    ...
                    {{ request()->routeIs('admin.commission.*') ? 'bg-[#00995c] text-white' : 'text-gray-700 hover:bg-gray-50' }}">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-6h2v6zm0-8h-2V7h2v2z" fill="none" stroke="currentColor" stroke-width="1.5"/>
