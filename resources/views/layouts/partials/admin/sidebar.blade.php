<aside
    class="admin-sidebar fixed left-0 top-0 h-screen flex flex-col shadow-lg transition-all duration-300 hidden md:flex">
    <button id="admin-mobile-btn-close" class="block md:hidden p-2 text-gray-600 hover:bg-gray-100 rounded-md text-end">
        ✕
    </button>
    ...
    <div class="bg-white px-3  pb-2">
        <a href="{{ route('admin.profile.edit') }}"
            class="flex items-center space-x-2 group {{ request()->routeIs('admin.profile.edit') ? 'bg-[#00995c] text-white' : '' }} rounded-lg p-2 transition-colors duration-200">
            <div
                ...
                @if(auth()->user()->avatar)
                    <img src="{{ route('admin.profile.avatar.view') }}?t={{ time() }}" alt="Profile Image"
            ...
            <div>
                <p
                    class="flex items-center gap-3 text-sm font-medium {{ request()->routeIs('admin.profile.edit') ? 'text-white' : 'text-gray-900' }}">
                    {{ Auth::user()->name }}
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"
                        class="{{ request()->routeIs('admin.profile.edit') ? 'stroke-white' : '' }}">
                ...
                <p
                    class="text-xs {{ request()->routeIs('admin.profile.edit') ? 'text-yellow-200' : 'text-yellow-600' }}">
                    Admin
                </p>
            </div>
        </a>
        ...
        <div class="space-y-1">
            <div>
                <a href="{{ route('admin.dashboard') }}"
                    class="flex items-center gap-3 px-3 py-2 text-sm font-medium rounded-lg {{ request()->routeIs('admin.dashboard') ? 'bg-[#00995c] text-white' : 'text-gray-700 hover:bg-gray-50' }}">
    ...
    : 'text-gray-700 hover:bg-gray-50' }}">
                    <div class="flex items-center gap-3 ">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M2.11914 12.8089L4.7637 11.2546L16.3993 18.0919L13.7547 19.6448L2.11914 12.8089Z"
                                fill="#CECECE" />
                            <path d="M16.4008 18.3998L16.3982 18.0884L13.7537 19.6413V19.9527L16.4008 18.3998Z"
                                fill="#8DB3CD" />
                            <path d="M4.75903 14.3631L7.4036 12.8088L7.66793 12.9639L5.02336 14.5181L4.75903 14.3631Z"
                                fill="white" />
                            <path d="M7.66992 16.0665L10.3145 14.5135L10.5788 14.6686L7.93424 16.2229L7.66992 16.0665Z"
                                fill="white" />
                            <path d="M10.8425 17.9316L13.4871 16.3787L13.7514 16.5337L11.1069 18.088L10.8425 17.9316Z"
                                fill="white" />
                            <path
                            ...
                            <path d="M18.6458 8.06529L18.1172 7.75391L17.8516 7.91026L18.3802 8.22032L18.6458 8.06529Z"
                                fill="#718090" />
                            <path d="M12.6937 23.0558L12.165 22.7457V12.1798L12.6937 12.4899V23.0558Z" fill="#CECECE" />
                            <path d="M12.165 12.1849L17.4542 9.07629L17.9828 9.38768L12.6937 12.4949L12.165 12.1849Z"
                                fill="#CECECE" />
                            ...
                            <g style="mix-blend-mode:multiply">
                                <path d="M14.812 23.057L17.8524 21.2709L18.3811 21.5809L15.3407 23.3684L14.812 23.057Z"
                ...
                <div x-show="open" x-collapse x-cloak class="space-y-1 pl-3 mt-1">
                    ...
                    <a href="{{route('admin.hoardings.drafts')}}"
                    ...
                    <a href="{{route('admin.hoarding-attributes.index')}}"
            ...
            @can('import.manage')
                <div class="space-y-1">
                    <div x-data="{ open: @if(request()->routeIs('admin.import.*')) true @else false @endif }"
                        class="space-y-1">
                        ...
                        <button type="button" @click="open = !open"
                            ...
                            <div
                                class="flex items-center gap-3 {{ request()->routeIs('admin.import.*') ? 'text-white' : 'text-gray-700' }}">
                        ...
                        <div x-show="open" x-collapse x-cloak class="space-y-1 pl-3 mt-1">
                            <a href="{{ route('admin.import.dashboard') }}"
                                class="block px-6 py-1 text-sm rounded-md transition {{ request()->routeIs('admin.import.dashboard') ? 'bg-emerald-50 text-gray-900 border-[#00995c] pl-5 font-semibold' : 'text-gray-600 hover:bg-gray-50 hover:pl-5 border-transparent' }}">
                                - Inventory Import
                            </a>
                            <a href="{{ route('admin.import.enhanced') }}"
                                class="block px-6 py-1 text-sm rounded-md transition {{ request()->routeIs('admin.import.enhanced') ? 'bg-emerald-50 text-gray-900 border-[#00995c] pl-5 font-semibold' : 'text-gray-600 hover:bg-gray-50 hover:pl-5 border-transparent' }}">
                                - Manage Import
                            </a>
                        </div>
                    </div>
            ...
            <div x-data="{ open: {{ request()->routeIs('customer.enquiries.*') ? 'true' : 'false' }} }"
                ...
                <div x-show="open" x-collapse x-cloak class="space-y-1 pl-3 mt-1">
                    ...
                    <a href="{{ route('customer.enquiries.index') }}" class="block px-6 py-1 text-sm rounded-md transition
    ...
    request()->routeIs('vendor.enquiries.*')
    ? 'bg-[#00995c] text-white'
    : 'text-gray-700 hover:bg-gray-50' }}">
                    <div class="flex items-center gap-3
                        ">
    ...
    : 'text-gray-600 hover:bg-gray-50 hover:pl-5 border-transparent' }} block px-6 py-1 text-sm rounded-md transition">
        ...
        <div x-data="{ open: {{ request()->routeIs('admin.pos.*') ? 'true' : 'false' }} }" class="space-y-1">
            ...
            <div x-show="open" x-collapse x-cloak class="space-y-1 pl-3 mt-1">
                <a href="{{ route('admin.pos.dashboard') }}"
                    class="{{ request()->routeIs('admin.pos.dashboard') ? 'child-active bg-emerald-50 text-gray-900 font-semibold pl-5' : 'text-gray-600 hover:bg-gray-50 hover:pl-5' }} block px-6 py-1 text-sm rounded-md transition">
                    - POS Dashboard
                </a>
                <a href="{{ route('admin.pos.create') }}"
                    class="{{ request()->routeIs('admin.pos.create') ? 'child-active bg-emerald-50 text-gray-900 font-semibold pl-5' : 'text-gray-600 hover:bg-gray-50 hover:pl-5' }} block px-6 py-1 text-sm rounded-md transition">
                    - Create POS Booking
                </a>
                <a href="{{ route('admin.pos.list') }}"
                    class="{{ request()->routeIs('admin.pos.list') ? 'child-active bg-emerald-50 text-gray-900 font-semibold pl-5' : 'text-gray-600 hover:bg-gray-50 hover:pl-5' }} block px-6 py-1 text-sm rounded-md transition">
                    - POS Booking List
                </a>
                <a href="{{ route('admin.pos.customers') }}"
                    class="{{ request()->routeIs('admin.pos.customers') || request()->routeIs('admin.pos.customers.show') ? 'child-active bg-emerald-50 text-gray-900 font-semibold pl-5' : 'text-gray-600 hover:bg-gray-50 hover:pl-5' }} block px-6 py-1 text-sm rounded-md transition">
                    - POS Customers
                </a>
            </div>
        </div>
        ...
        <div class="space-y-1">
            <div x-data="{ open: @if(request()->routeIs('admin.vendors.*')) true @else false @endif }"
                class="space-y-1">
                {{-- Parent --}}
                <button type="button" @click="open = !open"
                    class="w-full flex items-center justify-between px-3 py-2 text-sm font-medium rounded-lg
                ...
                <div x-show="open" x-collapse x-cloak class="space-y-1 pl-3 mt-1">
                    ...
                    <a href="{{ route('admin.vendors.index') }}" class="block px-6 py-1 text-sm rounded-md transition
    ...
    : 'text-gray-600 hover:bg-gray-50 hover:pl-5 border-transparent' }}">
            ...
            <div x-data="{ open: @if(request()->routeIs('admin.customers.*')) true @else false @endif }"
                class="space-y-1">
                {{-- Parent --}}
                <button type="button" @click="open = !open"
                    class="w-full flex items-center justify-between px-3 py-2 text-sm font-medium rounded-lg
                ...
                <div x-show="open" x-collapse x-cloak class="space-y-1 pl-3 mt-1">
                    ...
                    <a href="{{ route('admin.customers.index') }}" class="block px-6 py-1 text-sm rounded-md transition
    ...
    : 'text-gray-600 hover:bg-gray-50 hover:pl-5 border-transparent' }}">
            ...
            <div class="space-y-1">
                <div x-data="{ open: @if(request()->routeIs('admin.settings.*')) true @else false @endif }"
                    class="space-y-1">
                    {{-- Parent: Settings --}}
                    <button type="button" @click="open = !open"
                        ...
                        <div
                            class="flex items-center gap-3 {{ request()->routeIs('admin.settings.*') ? 'text-white' : 'text-gray-700' }}">
                    ...
                    <div x-show="open" x-collapse x-cloak class="space-y-1 pl-3 mt-1">
                        ...
                        <a href="{{ route('admin.settings.vendor_auto_approval.edit') }}"
                            class="block px-6 py-1 text-sm rounded-md transition {{ request()->routeIs('admin.settings.vendor_auto_approval.edit') ? 'bg-emerald-50 text-gray-900 border-[#00995c] pl-5 font-semibold' : 'text-gray-600 hover:bg-gray-50 hover:pl-5 border-transparent' }}">
                            - Vendor Auto Approval
                        </a>
            ...
            <div>
                <button type="button" onclick="openLogoutModal()" class="block sidebar-logout w-full flex items-center gap-3 px-3 py-2 text-sm font-medium rounded-lg
